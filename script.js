...
// generate bot response using API 
 const generateBotResponse=async (incomingMessageDiv) =>{
    ...
    try{
        ...
        //extrat and display bots response text
        ...
        //reset user's file data,removing thinking indicator and scroll chjat to bottom
        userData.file={};
...
const handleOutGoingMessage=(e)=>{
    ...
    chatBody.scrollTo({top:chatBody.scrollHeight,behavior:"smooth"});
     ...
     //simulatenbot response with thinking indicator after a delay
    setTimeout(()=>{
